...
$(function (){
	var id='${id}';
	var path="${_baseUrl}/auditLogController/viewInfo";
	$.ajax({    
		type: "POST",    
		async: false,    
		url:path,   
		...
		success: function (data) {   
			...
			$("#logNameType").val(data.logNameType);
...
<body>
	<form name="auditLog" id="auditLog" action="${_baseUrl}/auditLogController/edit" method="post">  
    ...
    <ul>
      ...
      <tr>
        ...
        <td width="187" valign="top">
        	<div class="jbxinxi_s">
        		<input type="text" name="logName" id="logName"  class="jbxinxi_input"/>
        	</div>
        </td>
        <td width="150" align="center" bgcolor="#f7f4f4">日志名称类型</td>
        <td width="185" valign="top"><div class="jbxinxi_s"><input type="text" name="logNameType" id="logNameType" class="jbxinxi_input"></div></td>
      </tr>
      <tr>
      	<td height="50" align="center" valign="middle" bgcolor="#f7f4f4">用户账号</td>
        <td valign="top"><div class="jbxinxi_s"><input type="text" name="userId" id="userId" class="jbxinxi_input"></div></td>
      ...
      <tr>
        ...
        <td valign="top"><div class="jbxinxi_s"><input type="text" name="deptName" id="deptName" class="jbxinxi_input"></div></td>
      ...
      <tr>
       <td height="50" align="center" valign="middle" bgcolor="#f7f4f4">操作时间</td>
        <td valign="top"><div class="jbxinxi_s"><input type="text" name="operTime" id="operTime" class="jbxinxi_input"></div></td>
      </tr>
      <tr>
