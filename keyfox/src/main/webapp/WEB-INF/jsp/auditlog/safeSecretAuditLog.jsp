...
$(function (){
	...
	menuList = $("#menuList").bootstrapTable({
		url : '${_baseUrl}/auditLogController/safeSecretAuditLog?startDate=${startDate}&endDate=${endDate}',
		pagination: true,
		pageList: [5, 10, 20, 50],
...
function exportExcel(){
	var path= '${_baseUrl}/auditLogController/exportExcel?type=safeSecret&startDate='+$("#startTime").val()+'&endDate='+$("#endTime").val();
...
function refreshTable(){
	...
	menuList.bootstrapTable('refresh',{url:'${_baseUrl}/auditLogController/safeSecretAuditLog?startDate='+startDate+'&endDate='+endDate});
}
</script>

</head>
<style>
	.clearCross { display:none;}   /* 调整显示样式  */
	ul,ol { margin:0;}
</style>
<body>
<div class="main_cont">
        	<div class="main_c">
                <div class="current_cont">
                    <div class="fl current_c">
                         当前位置 ： <a href="javascript:;">审计管理</a>  >  <a href="javascript:;">审计管理</a>  >  安全保密员审计
                    </div>            
                    <div class="fr current_j">
                        <ul>
                            <li>
                            <%-- 	<shiro:hasPermission name="auditLogController:addSnapshot_2"> --%>
							       <a href="javascript:;" class="current_1" onClick="addSnapshotFun();">归档</a>
							   <%--  </shiro:hasPermission> --%>
                            </li>
                            <li>
                            <%-- 	<shiro:hasPermission name="auditLogController:delete_2"> --%>
