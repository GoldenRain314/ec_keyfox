...
<br>
    ...
    <table width="723" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="120" height="50" align="center" valign="middle" bgcolor="#f7f4f4"> 系统密级
        	<input type="hidden" id="id" name="id" />
        </td>
        <td width="237" valign="middle">
        	<div class="qr_input">
        		<select name="systemLevel" id="systemLevel" class="qr_select fl	" style="width:202px; height:auto; padding:5px 0;margin-top: 11px;">
        ...
        <td width="237">
        	<div class="jbxinxi_s" style="width:auto;">
        		<input type="text" name="pwdLocktimes" id="pwdLocktimes" class="validate[required,custom[positiveInteger]] jbxinxi_input" style="width:195px;"></div><div class="jbxinxi_span1">*</div></td>
        	
      </tr>
      <tr>
        <td height="50" align="center" valign="middle" bgcolor="#f7f4f4">最短密码长度</td>
        <td><div class="jbxinxi_s" style="width:auto;"><input type="text" name="minimumPwdLength" id="minimumPwdLength" class="validate[required,custom[positiveInteger]] jbxinxi_input" style="width:195px;"></div><div class="jbxinxi_span1">*</div></td>
        <td align="center" bgcolor="#f7f4f4">最长密码长度</td>
        <td valign="top"><div class="jbxinxi_s" style="width:auto;"><input type="text" name="maximumPwdLength" id="maximumPwdLength" class="validate[required,custom[positiveInteger]] jbxinxi_input"  style="width:195px;"></div><div class="jbxinxi_span1">*</div></td>
      </tr>
      <tr>
        <td height="50" align="center" valign="middle" bgcolor="#f7f4f4">密码失效时间(天)</td>
        <td valign="middle">
        	<div class="jbxinxi_s" style="width:auto;"><input type="text" name="pwdExpirationTime" id="pwdExpirationTime" class="validate[required,custom[positiveInteger]] jbxinxi_input" style="width:195px;"></div><div class="jbxinxi_span1">*</div></td>
        <td align="center" bgcolor="#f7f4f4">用户非活跃时间(天)</td>
        <td valign="top"><div class="jbxinxi_s" style="width:auto;"><input type="text" name="userInactiveTime" id="userInactiveTime" class="validate[required,custom[positiveInteger]] jbxinxi_input" style="width:195px;"></div><div class="jbxinxi_span1">*</div></td>
      </tr>
      <tr>
        <td height="50" align="center" valign="middle" bgcolor="#f7f4f4">口令更换周期(天)</td>
        <td><div class="jbxinxi_s" style="width:auto;"><input type="text" name="pwdChangeCycle" id="pwdChangeCycle" class="validate[required,custom[positiveInteger]] jbxinxi_input" style="width:195px;"></div><div class="jbxinxi_span1">*</div></td>
