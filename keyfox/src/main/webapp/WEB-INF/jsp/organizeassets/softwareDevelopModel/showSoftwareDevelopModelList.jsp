...
var softwareDevelopModelList;
var searchValue = null;
function getSelect(){
	var selectId="";
	var objects =  $("#softwareDevelopModelList").bootstrapTable('getSelections');
...
$(function (){
	softwareDevelopModelList = $("#softwareDevelopModelList").bootstrapTable({
		url : '${_baseUrl}/softwareDevelopModel/selectSoftwareDevelopModelMessage',
		pagination: true,
        ...
        columns: [{
            ...
            field: 'developModelName',
            title: '软件开发模型',
            width: 100,
            formatter: function(value, row, index){
            	return "<a href='javascript:void(0)' onclick=\"updateSoftwareDevelopModel('"+row.id+"')\">"+value+"</a>";
            }
        },{
            field: 'code',
            title: '标识',
	...
	$("#add").click(function (){
		...
		$("#popIframe").attr("src","${_baseUrl}/softwareDevelopModel/addSoftwareDevelopModelMessage");
	});
	
	/* 删除*/
	$("#del").click(function (){
		var selected = softwareDevelopModelList.bootstrapTable('getSelections');
		...
		layer.confirm(options,{
    		...
    		function (){
    			$.ajax({
    				url : "${_baseUrl}/softwareDevelopModel/deleteSoftwareDevelopModelMessage",
    				type : "post",
    				dataType : "json",
...
function updateSoftwareDevelopModel(id){
	var userId = '<shiro:hasPermission name="softwareDevelopModel:addSoftwareDevelopModelMessage">1</shiro:hasPermission>';
	$("#popIframe").empty();
	$("#popDiv").dialog({
		title:(userId!='')?'修改软件开发模型':'软件开发模型',    /* 依据用户信息显示弹框标题   */ 
		autoOpen: true,
		modal: true,	
		height: 'auto',
		width: 700
	...
	$("#popIframe").attr("width","100%");
	$("#popIframe").attr("height","95%");
	$("#popIframe").attr("src","${_baseUrl}/softwareDevelopModel/updateSoftwareDevelopModelMessage?id="+id);
...
function refreshTable(){
	...
	softwareDevelopModelList.bootstrapTable('refresh');
}
function init(){
	...
	$("#popIframe").load(function () {   
	    ...
	    var temp = '<shiro:hasPermission name="softwareDevelopModel:addSoftwareDevelopModelMessage">1</shiro:hasPermission>';
       	...
       	<div class="main_c">
               <div class="current_cont">
                   <div class="fl current_c">
                        当前位置 ： <a href="javascript:;">组织资产</a>  >  <a href="javascript:;">软件设计类</a>  >  软件开发模型
                   </div>            
                   <div class="fr current_j">
                       <ul>
                           <li>
                           		<shiro:hasPermission name="softwareDevelopModel:addSoftwareDevelopModelMessage">
							       <a href="javascript:;" class="current_1" id="add">添加</a>
							    </shiro:hasPermission>
                           </li>
                           <li>
                           		<shiro:hasPermission name="softwareDevelopModel:deleteSoftwareDevelopModelMessage">
               ...
               <div class="personnel_cont">
		        <!--tab-w-01----->
		        <table id="softwareDevelopModelList" class="tab-w-01 tab-w-auto"></table>         
               </div>
