...
var technicalFileCatalogList;
var searchValue = null;
function getSelect(){
	var selectId="";
	var objects =  $("#technicalFileCatalogList").bootstrapTable('getSelections');
...
$(function (){
	technicalFileCatalogList = $("#technicalFileCatalogList").bootstrapTable({
		url : '${_baseUrl}/technicalFileCatalog/selectFileCatalogMessage',
		pagination: true,
        ...
        columns: [{
            ...
            field: 'workProductName',
            title: '工作产品名称',
            width: 70,
            formatter: function(value, row, index){
            	return "<a href='javascript:void(0)' onclick=\"updateFileCatalog('"+row.id+"')\" title='"+value+"'>"+subProjectName(value)+"</a>";
            }
        },{
            field: 'workProductCode',
            title: '工作产品标识',
            width: 70
        },{
            field: 'description',
	...
	$("#add").click(function (){
		...
		$("#popIframe").attr("src","${_baseUrl}/technicalFileCatalog/addFileCatalogMessage");
	});
	
	/* 删除*/
	$("#del").click(function (){
		var selected = technicalFileCatalogList.bootstrapTable('getSelections');
		...
		layer.confirm(options,{
    		...
    		function (){
    			$.ajax({
    				url : "${_baseUrl}/technicalFileCatalog/deleteFileCatalogMessage",
    				type : "post",
    				dataType : "json",
...
function updateFileCatalog(id){
	var userId = '<shiro:hasPermission name="technicalFileCatalog:addFileCatalogMessage">修改技术文档目录</shiro:hasPermission>';
	$("#popIframe").empty();
	$("#popDiv").dialog({
		title:(userId=='')?'技术文档目录':userId,   /* 依据用户id修改弹框名称  */
		autoOpen: true,
		modal: true,	
		height: 'auto',
		width: 700
	...
	$("#popIframe").attr("width","100%");
	$("#popIframe").attr("height","95%");
	$("#popIframe").attr("src","${_baseUrl}/technicalFileCatalog/updateFileCatalogMessage?id="+id);
...
function refreshTable(){
	...
	technicalFileCatalogList.bootstrapTable('refresh');
}
...
function init(){
	...
	$("#popIframe").load(function () {   
	    ...
	    var temp = '<shiro:hasPermission name="technicalFileCatalog:addFileCatalogMessage">1</shiro:hasPermission>';
       	...
       	<div class="main_c">
               <div class="current_cont">
                   <div class="fl current_c">
                        当前位置 ： <a href="javascript:;">组织资产</a>  >  <a href="javascript:;">软件管理类</a>  >  技术文档目录
                   </div>            
                   <div class="fr current_j">
                       <ul>
                           <li>
                           		<shiro:hasPermission name="technicalFileCatalog:addFileCatalogMessage">
							       <a href="javascript:;" class="current_1" id="add">添加</a>
							    </shiro:hasPermission>
                           </li>
                           <li>
                           		<shiro:hasPermission name="technicalFileCatalog:deleteFileCatalogMessage">
               ...
               <div class="personnel_cont">
		        <!--tab-w-01----->
		        <table id="technicalFileCatalogList" class="tab-w-01 tab-w-auto"></table>         
               </div>
