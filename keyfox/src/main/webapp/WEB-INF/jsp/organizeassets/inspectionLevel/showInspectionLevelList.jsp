...
var inspectionLevelList;
var searchValue = null;
function getSelect(){
	var selectId="";
	var objects =  $("#inspectionLevelList").bootstrapTable('getSelections');
...
$(function (){
	inspectionLevelList = $("#inspectionLevelList").bootstrapTable({
		url : '${_baseUrl}/inspectionLevel/selectInspectionLevelMessage',
		pagination: true,
        ...
        columns: [{
            ...
            width: 100,
            formatter: function(value, row, index){
            	return "<a href='javascript:void(0)' onclick=\"updateinspectionLevel('"+row.id+"')\">"+value+"</a>";
            }
        },{
            field: 'description',
            title: '说明',
	...
	$("#add").click(function (){
		...
		$("#popIframe").attr("src","${_baseUrl}/inspectionLevel/addInspectionLevelMessage");
	});
	
	/* 删除*/
	$("#del").click(function (){
		var selected = inspectionLevelList.bootstrapTable('getSelections');
		...
		layer.confirm(options,{
    		...
    		function (){
    			$.ajax({
    				url : "${_baseUrl}/inspectionLevel/deleteInspectionLevelMessage",
    				type : "post",
    				dataType : "json",
...
function updateinspectionLevel(id){
	$("#popIframe").empty();
	$("#popDiv").dialog({
		title:'修改评审级别',
		autoOpen: true,
	...
	$("#popIframe").attr("width","100%");
	$("#popIframe").attr("height","95%");
	$("#popIframe").attr("src","${_baseUrl}/inspectionLevel/updateInspectionLevelMessage?id="+id);
...
function refreshTable(){
	...
	inspectionLevelList.bootstrapTable('refresh');
}
function init(){
	...
	$("#popIframe").load(function () {   
	    ...
	    var temp = '<shiro:hasPermission name="inspectionLevel:addInspectionLevelMessage">1</shiro:hasPermission>';
       	...
       	<div class="main_c">
               <div class="current_cont">
                   <div class="fl current_c">
                        当前位置 ： <a href="javascript:;">组织资产</a>  >  <a href="javascript:;">软件管理类</a>  >  评审级别
                   </div>            
                   <div class="fr current_j">
                       <ul>
                           <li>
                           		<shiro:hasPermission name="inspectionLevel:addInspectionLevelMessage">
							       <a href="javascript:;" class="current_1" id="add">添加</a>
							    </shiro:hasPermission>
                           </li>
                           <li>
                           		<shiro:hasPermission name="inspectionLevel:deleteInspectionLevelMessage">
               ...
               <div class="personnel_cont">
		        <!--tab-w-01----->
		        <table id="inspectionLevelList" class="tab-w-01 tab-w-auto"></table>         
               </div>
