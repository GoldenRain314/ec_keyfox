...
var documentStandardsList;
var searchValue = null;
function getSelect(){
	var selectId="";
	var objects =  $("#documentStandardsList").bootstrapTable('getSelections');
...
$(function (){
	documentStandardsList = $("#documentStandardsList").bootstrapTable({
		url : '${_baseUrl}/projectDocumentStandards/selectDocumentStandardsMessage',
		pagination: true,
        ...
        columns: [{
            ...
            width: 100,
            formatter: function(value, row, index){
            	return "<a href='javascript:void(0)' onclick=\"updateDocumentStandards('"+row.id+"')\">"+value+"</a>";
            }
        },{
            field: 'description',
            title: '说明',
	...
	$("#add").click(function (){
		...
		$("#popIframe").attr("src","${_baseUrl}/projectDocumentStandards/addDocumentStandardsMessage");
	});
	
	/* 删除*/
	$("#del").click(function (){
		var selected = documentStandardsList.bootstrapTable('getSelections');
		...
		layer.confirm(options,{
    		...
    		function (){
    			$.ajax({
    				url : "${_baseUrl}/projectDocumentStandards/deleteDocumentStandardsMessage",
    				type : "post",
    				dataType : "json",
...
function updateDocumentStandards(id){
	var userId='<shiro:hasPermission name="projectDocumentStandards:addDocumentStandardsMessage">1</shiro:hasPermission>';
	$("#popIframe").empty();
	$("#popDiv").dialog({
		title:(userId!='')?'修改项目文档标准':'项目文档标准',     /* 依据用户信息显示弹框标题   */  
		autoOpen: true,
		modal: true,	
		height: 'auto',
		width: 700
	...
	$("#popIframe").attr("width","100%");
	$("#popIframe").attr("height","95%");
	$("#popIframe").attr("src","${_baseUrl}/projectDocumentStandards/updateDocumentStandardsMessage?id="+id);
...
function refreshTable(){
	...
	documentStandardsList.bootstrapTable('refresh');
}
function init(){
	...
	$("#popIframe").load(function () {   
	    ...
	    var temp = '<shiro:hasPermission name="projectDocumentStandards:addDocumentStandardsMessage">1</shiro:hasPermission>';
       	...
       	<div class="main_c">
               <div class="current_cont">
                   <div class="fl current_c">
                        当前位置 ： <a href="javascript:;">组织资产</a>  >  <a href="javascript:;">软件管理类</a>  >  项目文档标准
                   </div>            
                   <div class="fr current_j">
                       <ul>
                           <li>
                           		<shiro:hasPermission name="projectDocumentStandards:addDocumentStandardsMessage">
							       <a href="javascript:;" class="current_1" id="add">添加</a>
							    </shiro:hasPermission>
                           </li>
                           <li>
                           		<shiro:hasPermission name="projectDocumentStandards:deleteDocumentStandardsMessage">
               ...
               <div class="personnel_cont">
		        <!--tab-w-01----->
		        <table id="documentStandardsList" class="tab-w-01 tab-w-auto"></table>         
               </div>
