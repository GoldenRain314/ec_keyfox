...
// Node object
function Node(id, pid, name,code,level, url, title, target, icon, iconOpen, open,href) {
	this.id = id;
	this.nodeId=0;
	this.pid = pid;
	this.name = name;
...
function dTree(objName) {
	...
	this.icon = {
		root		: '/KD/resources/img/base.gif',
		folder		: '/KD/resources/img/folder.gif',
		folderOpen	: '/KD/resources/img/folderopen.gif',
		node		: '/KD/resources/img/page.gif',
		empty		: '/KD/resources/img/empty.gif',
		line		: '/KD/resources/img/line.gif',
		join		: '/KD/resources/img/join.gif',
		joinBottom	: '/KD/resources/img/joinbottom.gif',
		plus		: '/KD/resources/img/plus.gif',
		plusBottom	: '/KD/resources/img/plusbottom.gif',
		minus		: '/KD/resources/img/minus.gif',
		minusBottom	: '/KD/resources/img/minusbottom.gif',
		nlPlus		: '/KD/resources/img/nolines_plus.gif',
		nlMinus		: '/KD/resources/img/nolines_minus.gif'
	};
...
dTree.prototype.add = function(id, pid, name,code,level, url, title, target, icon, iconOpen, open,href) {
	this.aNodes[this.aNodes.length] = new Node(id, pid, name,code,level, url, title, target, icon, iconOpen, open,href);
};
...
dTree.prototype.s = function(id) {
	...
	if (this.selectedNode != id) {
		...
		if (this.config.useCookies) this.setCookie('cs' + this.obj, cn.id+","+cn.name+","+cn.code+","+cn.level+","+cn.href);
	}
};
